$(document).on('ready', function(){
	...
	var infowindow1 = new google.maps.InfoWindow({  
		content:  createInfo('<div class="popular-listing"> <div class="listing-features"> <ul class="save-preview"> <li><span><i class="la la-paperclip"></i>SAVE</span></li> <li><span><i class="la la-search"></i>PREVIEW</span></li> </ul> <div class="ad-cat"> <span>AD</span> </div> </div> <img src="http://placehold.it/268x391" alt="" /> <div class="pl-title-sec"> <a href="#" title="">3.2  Rating</a> <h3><a href="#" title="">Shoreline Village </a></h3> <span><i class="la la-map-marker"></i>Express Avenue Mall</span> </div></div>')
	}); 
